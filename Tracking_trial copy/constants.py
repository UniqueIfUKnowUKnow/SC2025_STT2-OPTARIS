...
# --- Tracking Settings ---
DEFAULT_SWEEP_RANGE = 10  # degrees
DEFAULT_ELEVATION_RANGE = 5  # degrees
MIN_SWEEP_RANGE = 2  # degrees
MIN_ELEVATION_RANGE = 1  # degrees
TRACKING_UPDATE_INTERVAL = 0.1  # seconds
